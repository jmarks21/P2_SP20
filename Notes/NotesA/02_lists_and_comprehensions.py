...
if random.randrange(10) in [3, 5, 6, 8]:
    print("yay!")
...
# LIST METHODS -- methods that belong to a class
...
last = "Parker"
print(first + last)
print(first, last) # squash 2 strings together
...
for name in my_list:
    name = name + "!"  # changes it in the loop but not in the list
    print(name)
...
# roll a signel die 100 times and add it to a list
...
print(my_doubles) # generates two die rolls and filters out for doubles
print(my_doubles)
